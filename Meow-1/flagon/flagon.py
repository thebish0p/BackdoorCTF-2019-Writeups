...
class Request(BaseRequest):
    ...
    def session(self):
        ...
        if not data:
            return JSONSecureCookie(secret_key=SECRET_KEY)
        return JSONSecureCookie.unserialize(data, SECRET_KEY)
...
def flagoninfo(request):
    ...
    status_data = os.environ.copy()
    status_data.pop('FLAGON_SECRET_KEY')
    status_data.pop('FLAG_1')
    status_data.pop('BOT_USER_PASSWORD')
